...
# Gestion des annotations imbriquées (d'après exemple basique suivant
# <adr>1 rue <pers>Jaurès</pers></adr>) par les options suivantes :
# - conservation des portions les plus englobantes : <adr>1 rue Jaurès</adr>
# - conservation des portions les plus détaillées : 1 rue <pers>Jaurès</pers>
# - combinaison des annotations : <adr>1 rue</adr> <adr-pers>Jaurès</adr-pers>
# - conservation en fonction de priorités (pers > ville > adr) soit en
#   supprimant le reste de l'imbrication : 1 rue <pers>Jaurès</pers> ;
#   soit en réduisant le reste : <adr>1 rue</adr> <pers>Jaurès</pers>
